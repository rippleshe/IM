...
>
> 工程代号：`IM-Training-Agent`。该代号仅用于源码、部署与技术复现；参赛作品正式名称为“智辩无幻”。

“智辩无幻”的目标不是做一个通用聊天机器人，也不是简单堆叠多个大模型 API，而是面向垂直领域技能训练，探索“学习者差异识别—多智能体协同决策—专业内容生成与校验—交互反馈—动态调整”的完整训练闭环。
