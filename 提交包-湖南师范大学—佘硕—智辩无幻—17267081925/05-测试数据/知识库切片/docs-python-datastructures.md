---
id: docs-python-datastructures
title: Python 官方教程 · Data Structures（数据结构）
source: Python 官方文档，PSF 许可 (https://docs.python.org/3/tutorial/datastructures.html)
locator: https://docs.python.org/3/tutorial/datastructures.html
trust: high
---
# 5\. Data Structures
