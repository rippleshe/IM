---
id: docs-mpl-histogram
title: matplotlib 官方示例 · Histogram（直方图）
source: matplotlib 官方文档，Matplotlib 许可 (https://matplotlib.org/stable/gallery/statistics/hist.html)
locator: https://matplotlib.org/stable/gallery/statistics/hist.html
trust: high
---
*
* Examples
...
for thisfrac, thispatch in zip(fracs, patches):
    color = plt.colormaps"viridis"(thisfrac))
...
Tags: plot-type: histogram plot-type: histogram2d domain: statistics styling: color component: normalization component: patch
